...
public enum SuperLog {
    ...
    private nonisolated(unsafe) static var isLoggingEnabled: Bool {
        #if DEBUG
            if isEnabled {
                return true
            }
    ...
    public nonisolated static func v(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    ///   - column: Column number of the log message
    ///   - funcName: Name of the function from where the logging is done
    public nonisolated static func d(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    ///   - column: Column number of the log message
    ///   - funcName: Name of the function from where the logging is done
    public nonisolated static func i(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    ///   - column: Column number of the log message
    ///   - funcName: Name of the function from where the logging is done
    public nonisolated static func e(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    ///   - column: Column number of the log message
    ///   - funcName: Name of the function from where the logging is done
    public nonisolated static func w(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    ///   - column: Column number of the log message
    ///   - funcName: Name of the function from where the logging is done
    public nonisolated static func c(_ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
    ...
    private nonisolated static func printLog(type: LogEvent, _ object: Any, filename: String, line: Int, column: Int, funcName: String) {
        if isLoggingEnabled {
    ...
    private nonisolated static func sourceFileName(filePath: String) -> String {
...
private extension Logger {
    ...
    nonisolated(unsafe) static let subsystem = Bundle.main.bundleIdentifier!
}
